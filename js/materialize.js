  ...
  var methods = {
    ...
    init : function(options) {
      var defaults = {
        ...
        arrowNav: false, // Toggle arrow navigation
      ...
      return this.each(function(i) {
        ...
        var $arrows = $('<a class="nav-arrows"></a>');
        ...
        var showArrows = (view.attr('data-arrow-nav') || options.arrowNav) && hasMultipleSlides;
        ...
        view.find('.carousel-item').each(function (i) {
          ...
          if (showArrows) {
            var $arrowR = $('<span class="right" onclick="$(\'.carousel\').carousel(\'next\');"></span>');
            var $arrowL = $('<span class="left" onclick="$(\'.carousel\').carousel(\'prev\');"></span>');
